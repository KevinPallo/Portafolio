...
<head>
	...
	<header>
			...
			<div class="Title-nombre">
				<h1 class="Title-nombre-texto">Multiples puntos</h1>
			</div>
			<nav>
				<ul>
		...
		<main>
			...
			<section class="subtitulos">
				...
				<section class="formulario-section">
					...
					<form action="MultPuntos.php" method="post">
						<div class="mb-3">
				...
				<?php
					if(isset($_POST['aceptar'])){
						...
						$y=$string[1];
						$h=($numEval-$x)/$n;
						MultPuntos($x,$y,$h,$n,$funcion,$tol);
					}

					function MultPuntos($x,$y,$h,$n,$funcion,$tol){
						do{
							$y=$y+($h/2)*(funcionEval($x,$y,$funcion)+funcionEval());
						}while(abs()>$tol);
